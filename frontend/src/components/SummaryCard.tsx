      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`rounded-md px-3 py-1.5 text-sm transition disabled:opacity-50 ${previewOverride === 1 ? "bg-teal-600 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"
              }`}
          >
            Pro
          </button>
          <button
            ...
            disabled={isOverrideLoading}
            className={`rounded-md px-3 py-1.5 text-sm transition disabled:opacity-50 ${previewOverride === 0.5 ? "bg-slate-500 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"
              }`}
          >
            Neutral
          </button>
          <button
            ...
            disabled={isOverrideLoading}
            className={`rounded-md px-3 py-1.5 text-sm transition disabled:opacity-50 ${previewOverride === 0 ? "bg-amber-600 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"
              }`}
          >
            Con
          </button>
